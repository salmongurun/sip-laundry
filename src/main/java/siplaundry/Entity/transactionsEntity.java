...
public class transactionsEntity extends Entity {
 ...
 //   public transactionsEntity(java.util.Date transaksi_date, java.util.Date picup_date, LaundryStatus finish, PaymentStatus paid, int i, UserEntity user, CustomerEntity customer){}   
    
    public transactionsEntity() {
    }

    public transactionsEntity(Date transactionDate, Date pickup_Date, LaundryStatus status, PaymentStatus payment_status, int amount, UserEntity user_id, CustomerEntity customer_id ){
